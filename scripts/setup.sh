...
docker run -itd --rm --name wiremock-container -p 8080:8080 --add-host host.docker.internal:host-gateway -v "$PWD"/extensions:/var/wiremock/extensions wiremock/wiremock:2.31.0 --record-mappings --verbose --extensions org.wiremock.webhooks.Webhooks
